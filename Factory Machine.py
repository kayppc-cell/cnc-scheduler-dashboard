...
DEFAULT_JOBS = [
    {"แผนงาน": "26-117", "ชื่อ Drawing.": "P26-PES-105-004-Unit8", "วัสดุ": "SS400", "ประเภทงาน": "🟢 งานปกติ", "ขั้นตอน (Step)": "step1", "เลือกเครื่องจักร": "No.1 Awea", "วัน-เวลาขึ้นงาน": datetime(2026, 8, 20, 8, 0), "เวลาตั้งเครื่อง (นาที)": 15, "Basic Machine (ชม.)": 1.0, "รันโปรแกรม (ชม.)": 3.0, "สถานะงาน": "✅ เสร็จสิ้นแล้ว"},
    {"แผนงาน": "26-117", "ชื่อ Drawing.": "P26-PES-105-004-Unit8", "วัสดุ": "SS400", "ประเภทงาน": "🟢 งานปกติ", "ขั้นตอน (Step)": "step2", "เลือกเครื่องจักร": "No.1 Awea", "วัน-เวลาขึ้นงาน": datetime(2026, 8, 20, 14, 0), "เวลาตั้งเครื่อง (นาที)": 15, "Basic Machine (ชม.)": 1.5, "รันโปรแกรม (ชม.)": 4.5, "สถานะงาน": "⚙️ กำลังผลิต"},
    {"แผนงาน": "26-117", "ชื่อ Drawing.": "P26-PES-105-004-Unit8", "วัสดุ": "SS400", "ประเภทงาน": "🟢 งานปกติ", "ขั้นตอน (Step)": "step3", "เลือกเครื่องจักร": "No.1 Awea", "วัน-เวลาขึ้นงาน": datetime(2026, 8, 21, 8, 0), "เวลาตั้งเครื่อง (นาที)": 15, "Basic Machine (ชม.)": 1.0, "รันโปรแกรม (ชม.)": 3.0, "สถานะงาน": "⏳ รอคิวผลิต"},
    {"แผนงาน": "26-102", "ชื่อ Drawing.": "P26-PES-105-007-Unit9", "วัสดุ": "SS400", "ประเภทงาน": "🟢 งานปกติ", "ขั้นตอน (Step)": "จบใน Process", "เลือกเครื่องจักร": "No.4 Sanco", "วัน-เวลาขึ้นงาน": datetime(2026, 8, 20, 8, 0), "เวลาตั้งเครื่อง (นาที)": 10, "Basic Machine (ชม.)": 2.0, "รันโปรแกรม (ชม.)": 4.0, "สถานะงาน": "✅ เสร็จสิ้นแล้ว"},
    {"แผนงาน": "26-102", "ชื่อ Drawing.": "P26-PES-105-008-Unit9", "วัสดุ": "SS400", "ประเภทงาน": "🟢 งานปกติ", "ขั้นตอน (Step)": "จบใน Process", "เลือกเครื่องจักร": "No.9 Mikron", "วัน-เวลาขึ้นงาน": datetime(2026, 8, 20, 8, 0), "เวลาตั้งเครื่อง (นาที)": 10, "Basic Machine (ชม.)": 1.0, "รันโปรแกรม (ชม.)": 7.0, "สถานะงาน": "⚙️ กำลังผลิต"},
    {"แผนงาน": "26-102", "ชื่อ Drawing.": "P26-PES-105-009-Unit9", "วัสดุ": "SS400", "ประเภทงาน": "🟢 งานปกติ", "ขั้นตอน (Step)": "จบใน Process", "เลือกเครื่องจักร": "No.9 Mikron", "วัน-เวลาขึ้นงาน": datetime(2026, 8, 20, 17, 30), "เวลาตั้งเครื่อง (นาที)": 10, "Basic Machine (ชม.)": 1.0, "รันโปรแกรม (ชม.)": 7.0, "สถานะงาน": "⏳ รอคิวผลิต"},
    {"แผนงาน": "26-102", "ชื่อ Drawing.": "P26-PES-105-010-Unit9", "วัสดุ": "SS400", "ประเภทงาน": "🟢 งานปกติ", "ขั้นตอน (Step)": "จบใน Process", "เลือกเครื่องจักร": "No.2 Awea", "วัน-เวลาขึ้นงาน": datetime(2026, 8, 20, 8, 0), "เวลาตั้งเครื่อง (นาที)": 10, "Basic Machine (ชม.)": 4.0, "รันโปรแกรม (ชม.)": 12.0, "สถานะงาน": "⚙️ กำลังผลิต"},
    {"แผนงาน": "26-105", "ชื่อ Drawing.": "P26-PES-105-001-Unit10", "วัสดุ": "SS400", "ประเภทงาน": "🟢 งานปกติ", "ขั้นตอน (Step)": "จบใน Process", "เลือกเครื่องจักร": "No.3 Hartford", "วัน-เวลาขึ้นงาน": datetime(2026, 8, 20, 8, 0), "เวลาตั้งเครื่อง (นาที)": 10, "Basic Machine (ชม.)": 2.0, "รันโปรแกรม (ชม.)": 6.0, "สถานะงาน": "⏳ รอคิวผลิต"},
    {"แผนงาน": "26-105", "ชื่อ Drawing.": "P26-PES-105-002-Unit10", "วัสดุ": "SS400", "ประเภทงาน": "🟢 งานปกติ", "ขั้นตอน (Step)": "จบใน Process", "เลือกเครื่องจักร": "No.5 Hartford", "วัน-เวลาขึ้นงาน": datetime(2026, 8, 20, 8, 0), "เวลาตั้งเครื่อง (นาที)": 10, "Basic Machine (ชม.)": 2.0, "รันโปรแกรม (ชม.)": 6.0, "สถานะงาน": "⏳ รอคิวผลิต"},
    {"แผนงาน": "26-105", "ชื่อ Drawing.": "P26-PES-105-003-Unit10", "วัสดุ": "SS400", "ประเภทงาน": "🟢 งานปกติ", "ขั้นตอน (Step)": "จบใน Process", "เลือกเครื่องจักร": "No.6 Bridgeport", "วัน-เวลาขึ้นงาน": datetime(2026, 8, 20, 8, 0), "เวลาตั้งเครื่อง (นาที)": 10, "Basic Machine (ชม.)": 1.5, "รันโปรแกรม (ชม.)": 4.5, "สถานะงาน": "⏳ รอคิวผลิต"},
    {"แผนงาน": "26-105", "ชื่อ Drawing.": "P26-PES-105-004-Unit10", "วัสดุ": "SS400", "ประเภทงาน": "🟢 งานปกติ", "ขั้นตอน (Step)": "จบใน Process", "เลือกเครื่องจักร": "No.7 Bridgeport", "วัน-เวลาขึ้นงาน": datetime(2026, 8, 20, 8, 0), "เวลาตั้งเครื่อง (นาที)": 10, "Basic Machine (ชม.)": 1.5, "รันโปรแกรม (ชม.)": 4.5, "สถานะงาน": "⏳ รอคิวผลิต"},
    {"แผนงาน": "26-105", "ชื่อ Drawing.": "P26-PES-105-005-Unit10", "วัสดุ": "SS400", "ประเภทงาน": "🟢 งานปกติ", "ขั้นตอน (Step)": "จบใน Process", "เลือกเครื่องจักร": "No.8 Hartford", "วัน-เวลาขึ้นงาน": datetime(2026, 8, 20, 8, 0), "เวลาตั้งเครื่อง (นาที)": 10, "Basic Machine (ชม.)": 2.0, "รันโปรแกรม (ชม.)": 6.0, "สถานะงาน": "⏳ รอคิวผลิต"},
    {"แผนงาน": "26-199", "ชื่อ Drawing.": "P26-PES-110-001-Unit20", "วัสดุ": "SS400", "ประเภทงาน": "🔴 งานด่วนแทรก", "ขั้นตอน (Step)": "จบใน Process", "เลือกเครื่องจักร": "No.3 Hartford", "วัน-เวลาขึ้นงาน": datetime(2026, 8, 20, 13, 0), "เวลาตั้งเครื่อง (นาที)": 10, "Basic Machine (ชม.)": 1.0, "รันโปรแกรม (ชม.)": 3.0, "สถานะงาน": "⏳ รอคิวผลิต"},
]
...
with st.expander("📝 จัดการรายการสั่งผลิต (แยกหมวด Basic Machine / รันโปรแกรม)", expanded=True):
    ...
    column_order = [
        ...
        "เลือกเครื่องจักร",
        "วัน-เวลาขึ้นงาน",
        "เวลาตั้งเครื่อง (นาที)",
        "Basic Machine (ชม.)",
        "รันโปรแกรม (ชม.)",
        "รวม (ชม.)",
        "สถานะงาน",
    ]
    calc_df = calc_df[column_order]
    ...
    edited_jobs = st.data_editor(
        ...
        column_config={
            ...
            "Basic Machine (ชม.)": st.column_config.NumberColumn("🛠️ Basic (ชม.)", help="ปาดผิว, เจาะรู, ต๊าปเกลียว", width=95, min_value=0.0, max_value=100.0, step=0.5, format="%.1f", required=True),
            "รันโปรแกรม (ชม.)": st.column_config.NumberColumn("💻 โปรแกรม (ชม.)", help="Copy Surface, เดินโปรไฟล์รอบตัว", width=105, min_value=0.0, max_value=200.0, step=0.5, format="%.1f", required=True),
            "รวม (ชม.)": st.column_config.NumberColumn("⏳ รวม (ชม.)", help="คำนวณอัตโนมัติ (Setup/60 + Basic + โปรแกรม)", width=85, format="%.2f", disabled=True),
    ...
    st.session_state.jobs_data = edited_jobs[[c for c in edited_jobs.columns if c != "รวม (ชม.)"]]
...
if not df_summary.empty:
    ...
    display_cols = [c for c in df_display.columns if c != "เวลาเริ่มจริง"]
